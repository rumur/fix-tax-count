<?php
namespace Rumur\Admin\Service;

use Rumur\Service\Notice\Notice;

use WP_Error;

/**
 * Class NoticeAdmin
 * @package Rumur\Admin\Service
 * @author rumur
 */
class NoticeAdmin extends Notice {
	...
	protected function render( array $messages = array(), $type = 'error' )
	{
        ...
        $html = apply_filters(sanitize_title(__NAMESPACE__) . '_admin_template', '<div class="%1$s"><p><strong>%2$s</strong></p></div>');
